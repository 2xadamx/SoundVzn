...
// En producción (dist/): __dirname = backend/dist/ → subir 2 niveles al root
// En desarrollo (ts-node): __dirname = backend/ → subir 1 nivel al root
...
// ——— Google OAuth ———
export const GOOGLE_CLIENT_ID: string = process.env.GOOGLE_CLIENT_ID || process.env.VITE_GOOGLE_CLIENT_ID || '';
